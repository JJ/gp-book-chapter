...
problems. In both cases, when the problem faced is complex, GAs and GP require a large amount of computing resources.
The more complex the problem, the larger the computing requirements. This fact leads to a sometimes prohibitively long time to solution that happens, for example, when tackling real-world problems. In order to reduce the execution time of EAs, researchers have applied parallel and distributed programming during the last decades. 
